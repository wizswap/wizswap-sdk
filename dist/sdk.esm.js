...
import IWizPair from '@wizswap-libs/wiz-swap-core/build/IWizPair.json';
...
var WETH = (_WETH = {}, _WETH[ChainId.MAINNET] = /*#__PURE__*/new Token(ChainId.MAINNET, '0xA29D0ee618f33d8eFE9A20557fd0EF63dD050859', 18, 'WPWR', 'Wrapped Pwr'), _WETH[ChainId.TESTNET] = /*#__PURE__*/new Token(ChainId.TESTNET, '0xae13d989dac2f0debff460ac112a837c89baa7cd', 18, 'WETH', 'Wrapped Ether'), _WETH);
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new Contract(address, IWizPair.abi, provider).getReserves()).then(function (_ref) {
